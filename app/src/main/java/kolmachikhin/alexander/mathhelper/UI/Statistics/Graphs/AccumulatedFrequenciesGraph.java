...
public class AccumulatedFrequenciesGraph extends Graph {

    private int[] points;

    public AccumulatedFrequenciesGraph(Context c, StatisticsAnalyzer a, int t) {
        super(c, a, t);
        points = a.getAccumulatedFrequencies();
    }

    protected void drawYPoints() {
        for (int i = 0; i < analyzer.getMaxAccumulatedFrequency() + 2; i++) {
